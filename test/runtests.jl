...
# !!! Main.UserApp is configured as an alias for Main.WatchTonight and you might encounter it in some tests
using Main.WatchTonight, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "WatchTonight tests" begin
  @includetests ARGS
end
